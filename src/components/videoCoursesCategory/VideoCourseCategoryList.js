...
function VideoCourseCategorylist() {
  ...
  useEffect(() => {
    let apiCall = async () => {
      let res = await fetch(`${BASE_URL}/api/videocoursecategory/allcourses`, {
        method: "GET",
        headers: {
  ...
  const handleDelete = (id) => {
    let apiCall = async () => {
      let res = await fetch(`${BASE_URL}/api/videocoursecategory/delete/${id}`, {
        method: "POST",
        headers: {
          "Authorization": (localStorage.getItem("token"))
        },
  ...
  const handleStatus = (id) => {
    let apiCall = async () => {
      let res = await fetch(`${BASE_URL}/api/videocoursecategory/active/${id}`, {
        method: "PUT",
        headers: {
          "Authorization": (localStorage.getItem("token"))
        },
              ...
              <div className="row align-items-center">
                <div className="col-md-12">
                  <ul className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <Link to="">Video Category Management</Link>
                    </li>
