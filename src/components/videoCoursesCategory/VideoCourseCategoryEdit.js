...
export default function VideoCourseCategoryEdit() {
  ...
  useEffect(() => {
    const apiCall = async () => {
      let response = await fetch(`${BASE_URL}/api/videocoursecategory/details/${id}`, {
        method: "GET",
        headers: {
  ...
  const handelOnSubmit = (e) => {
    ...
    const apiCall = async () => {
      let response = await fetch(`${BASE_URL}/api/videocoursecategory/edit/${id}`, {
        method: "POST",
        headers: {
          "Authorization": (localStorage.getItem("token"))
        },
                ...
                <div className="col-md-12">
                  <ul className="breadcrumb">
                    ...
                    <li className="breadcrumb-item" aria-current="page">
                      Edit Video Course Category
                    </li>
                  </ul>
                </div>
                <div className="col-md-12">
                  <div className="page-header-title">
                    <h2 className="mb-0">Edit Video Course Category</h2>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-12">
              <div className="card">
                <div className="card-header">
                  <h5>Edit Video Course Category Details</h5>
                </div>
