...
export default function LiveVideoCourseEdit() {
  ...
  const handelOnSubmit = (e) => {
    ...
    const apiCall = async () => {
      let response = await fetch(`${BASE_URL}/api/livevideocourse/edit/${id}`, {
        method: "POST",
        headers: {
          "Authorization": (localStorage.getItem("token"))
        },
  ...
  const handleImgDelete = (imgid) => {
    const apiCall = async () => {
      let response = await fetch(`${BASE_URL}/api/livevideocourse/${id}/deleteimage/${imgid}`, {
        method: "POST",
        headers: {
          "Authorization": (localStorage.getItem("token"))
        },
              ...
              <div className="row align-items-center">
                <div className="col-md-12">
                  <ul className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <Link href="">Live Video Course Management
                      </Link>
                    </li>
                    <li className="breadcrumb-item" aria-current="page">
                      Live Video Course Edit
                    </li>
                  </ul>
                </div>
                <div className="col-md-12">
                  <div className="page-header-title">
                    <h2 className="mb-0">Live Video Course Edit</h2>
                  </div>
                </div>
              </div>
            </div>
